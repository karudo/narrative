...
am['spine/manager']=module.exports;
module.exports=null;(function() {
  var utils;
...
module.exports=null;(function() {
  ...
  DragImage = (function(_super) {
    ...
    DragImage.prototype.noManage = true;
...
module.exports=null;(function() {
  ...
  Editor = (function(_super) {
    ...
    Editor.prototype.insertFigure = function(options) {
      ...
      return this.figures[figureId] = new Obj({
        el: this.$('#' + figureId)
      });
    };
...
module.exports=null;(function() {
  ...
  FigureSlider = (function(_super) {
    ...
    FigureSlider.prototype.addSlide = function(image, dragImageOptions) {
      var $imageUpload, $sliderSource, DragImage, cdi, slideId,
        _this = this;
      if (dragImageOptions == null) {
        dragImageOptions = {};
      }
      ...
      DragImage = require('controllers/DragImage');
      cdi = this.dragImages[slideId] = new DragImage(dragImageOptions);
      if (image) {
    ...
    FigureSlider.prototype.drop = function(event) {
      ...
      event.preventDefault();
      return this.addSlide((_ref = event.originalEvent.dataTransfer) != null ? _ref.files[0] : void 0);
    };
